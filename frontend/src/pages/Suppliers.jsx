...
const Suppliers = () => {
  ...
  const { data: suppliersData, isLoading } = useQuery({
    ...
    queryFn: () => supplierService.getAll(page, size), // Note: If you want search to work, you might need to pass `search` here like the Customer page does.
  });
                ...
                >
                  ...
                  {isManager() && (
                    <TableCell align="right" sx={{ whiteSpace: 'nowrap' }}>
                      {/* 👇 FIXED: Now correctly navigates to the edit page */}
                      <IconButton 
                        size="small" 
                        color="primary" 
