...
const PurchaseForm = () => {
  ...
  const [formData, setFormData] = useState({ supplierId: preselectSupplierId, purchaseDate: new Date().toISOString().split('T')[0], notes: '' });
  const [items, setItems] = useState(
    preselectProductId ? [{ productId: preselectProductId, quantity: 1, unitCost: 0 }] : []
  );
